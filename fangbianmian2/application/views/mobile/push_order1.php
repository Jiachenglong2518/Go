...
<div id="push_order_body">
    ...
    <div class="push_order_content">
        ...
        <div class="push_order_btn_content">
            <a href="wx/mobile_interpolate_process"><input type="button" class="push_order_btn push_order_btn_sel" value="帮他推"></a>
            <input type="button" class="push_order_btn" value="不帮推">
    ...
    <div class="push_order_content">
        ...
        <div class="push_order_btn_content">
            <input type="button" class="push_order_btn push_order_btn_sel" value="还原">
    ...
    <div class="push_order_content">
        ...
        <div class="push_order_btn_content">
            <input type="button" class="push_order_btn push_order_btn_sel" value="申请取消">
            <input type="button" class="push_order_btn" value="删除">
            <input type="button" class="push_order_btn" value="联系他">
        </div>
    </div>
