...
<div id="infor_container">
    <div id="infor_content">
        <form action="">
            ...
            <input type="button" class="infor_btn infor_btn_c" value="发布面试">
