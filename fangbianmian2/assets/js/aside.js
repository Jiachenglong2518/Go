...
$(function(){
    //鼠标移入改变图标颜色和字体颜色
    $('.menu').hover(function(){
        $(this).css('background-image',"url('images/jobhunter-side-green.png')").children('a').css('color',"#5de1a8");
        $(this).css('color','#5de1a8');


    },function(){
        $(this).css('background-image',"url('images/jobhunter-side-gray.png')").children('a').css('color',"#607684");
